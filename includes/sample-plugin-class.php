...
class Sample_Plugin_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
			'sample_plugin_widget', // Base ID
			__( 'Sample Plugin', 'sp_domain' ), // Name
			array( 'description' => __( 'A simple email subscriber', 'sp_domain' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		?>
			...
			<div id="form-msg"></div>
			<form id="subscriber-form" method="post" action="<?php echo plugins_url().'/sample-plugin/includes/sample-plugin-mailer.php'; ?>">
	...
	public function form( $instance ) {
		// outputs the options form on admin
		$title = !empty($instance['title']) ? $instance['title'] : __('Sample Plugin', 'sp_domain');
		$recipient = $instance['recipient'];
		$subject = !empty($instance['subject']) ? $instance['subject'] : __('You have a new subscriber', 'sp_domain');
	?>
		<p>
